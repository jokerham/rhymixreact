...
export const updateNotifyReadedByTargetSrlQuery = {
  id: 'updateNotifyReadedByTargetSrl',
...
export type UpdateNotifyReadedByTargetSrlQueryDefinition = typeof updateNotifyReadedByTargetSrlQuery
