...
export const getTotalCommentCountByGroupStatusQuery = {
  id: 'getTotalCommentCountByGroupStatus',
  rhymixAction: 'select',
...
export type GetTotalCommentCountByGroupStatusQueryDefinition =
  typeof getTotalCommentCountByGroupStatusQuery
