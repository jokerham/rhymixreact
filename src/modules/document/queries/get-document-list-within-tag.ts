...
export const getDocumentListWithinTagQuery = {
  id: 'getDocumentListWithinTag',
  rhymixAction: 'select',
...
export type GetDocumentListWithinTagQueryDefinition = typeof getDocumentListWithinTagQuery
