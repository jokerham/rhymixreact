...
export const getTotalCommentListWithinMemberQuery = {
  id: 'getTotalCommentListWithinMember',
  rhymixAction: 'select',
  firestoreOperation: 'read',
  sourceTables: ['comments', 'documents', 'member'],
  targets: [
    {
      collection: 'comments',
...
export type GetTotalCommentListWithinMemberQueryDefinition =
  typeof getTotalCommentListWithinMemberQuery
