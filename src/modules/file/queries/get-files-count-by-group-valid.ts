...
export const getFilesCountByGroupValidQuery = {
  id: 'getFilesCountByGroupValid',
  rhymixAction: 'select',
...
export type GetFilesCountByGroupValidQueryDefinition = typeof getFilesCountByGroupValidQuery
