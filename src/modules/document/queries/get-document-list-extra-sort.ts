...
export const getDocumentListExtraSortQuery = {
  id: 'getDocumentListExtraSort',
  rhymixAction: 'select',
...
export type GetDocumentListExtraSortQueryDefinition = typeof getDocumentListExtraSortQuery
