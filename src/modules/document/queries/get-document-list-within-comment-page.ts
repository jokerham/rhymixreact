...
export const getDocumentListWithinCommentPageQuery = {
  id: 'getDocumentListWithinCommentPage',
  rhymixAction: 'select',
...
export type GetDocumentListWithinCommentPageQueryDefinition =
  typeof getDocumentListWithinCommentPageQuery
