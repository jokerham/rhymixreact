...
export const getCommentListByMemberSrlQuery = {
  id: 'getCommentListByMemberSrl',
  rhymixAction: 'select',
...
export type GetCommentListByMemberSrlQueryDefinition = typeof getCommentListByMemberSrlQuery
