...
export const updateDocumentsAllowCommentTrackbackQuery = {
  id: 'updateDocumentsAllowCommentTrackback',
  rhymixAction: 'update',
...
export type UpdateDocumentsAllowCommentTrackbackQueryDefinition =
  typeof updateDocumentsAllowCommentTrackbackQuery
