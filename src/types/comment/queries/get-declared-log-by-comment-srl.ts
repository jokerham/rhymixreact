...
export const getDeclaredLogByCommentSrlQuery = {
  id: 'getDeclaredLogByCommentSrl',
  rhymixAction: 'select',
...
export type GetDeclaredLogByCommentSrlQueryDefinition = typeof getDeclaredLogByCommentSrlQuery
