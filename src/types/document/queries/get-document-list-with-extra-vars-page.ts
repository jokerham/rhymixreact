...
export const getDocumentListWithExtraVarsPageQuery = {
  id: 'getDocumentListWithExtraVarsPage',
  rhymixAction: 'select',
...
export type GetDocumentListWithExtraVarsPageQueryDefinition =
  typeof getDocumentListWithExtraVarsPageQuery
