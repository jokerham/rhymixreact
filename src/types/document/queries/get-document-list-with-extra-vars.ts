...
export const getDocumentListWithExtraVarsQuery = {
  id: 'getDocumentListWithExtraVars',
  rhymixAction: 'select',
...
export type GetDocumentListWithExtraVarsQueryDefinition = typeof getDocumentListWithExtraVarsQuery
