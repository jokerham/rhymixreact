...
export const getNotifyMemberSrlBySrlQuery = {
  id: 'getNotifyMemberSrlBySrl',
...
export type GetNotifyMemberSrlBySrlQueryDefinition = typeof getNotifyMemberSrlBySrlQuery
