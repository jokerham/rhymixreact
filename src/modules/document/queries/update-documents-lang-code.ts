...
export const updateDocumentsLangCodeQuery = {
  id: 'updateDocumentsLangCode',
  rhymixAction: 'update',
...
export type UpdateDocumentsLangCodeQueryDefinition = typeof updateDocumentsLangCodeQuery
