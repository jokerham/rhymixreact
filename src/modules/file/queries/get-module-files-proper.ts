...
export const getModuleFilesProperQuery = {
  id: 'getModuleFilesProper',
  rhymixAction: 'select',
  firestoreOperation: 'read',
  sourceTables: ['files', 'documents', 'comments'],
  targets: [
    {
      collection: 'files',
...
export type GetModuleFilesProperQueryDefinition = typeof getModuleFilesProperQuery
