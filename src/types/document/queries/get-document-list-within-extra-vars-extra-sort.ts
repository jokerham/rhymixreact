...
export const getDocumentListWithinExtraVarsExtraSortQuery = {
  id: 'getDocumentListWithinExtraVarsExtraSort',
  rhymixAction: 'select',
...
export type GetDocumentListWithinExtraVarsExtraSortQueryDefinition =
  typeof getDocumentListWithinExtraVarsExtraSortQuery
