...
export const updateNotifyReadedBySrlQuery = {
  id: 'updateNotifyReadedBySrl',
...
export type UpdateNotifyReadedBySrlQueryDefinition = typeof updateNotifyReadedBySrlQuery
