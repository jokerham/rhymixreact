...
export const getDocumentExtraVarsCountQuery = {
  id: 'getDocumentExtraVarsCount',
  rhymixAction: 'select',
...
export type GetDocumentExtraVarsCountQueryDefinition = typeof getDocumentExtraVarsCountQuery
